...
extern StringNode nodeAndy,nodeThengChun,nodeRex,nodeJstan,nodeAlexander;
...
void initNodeString(StringNode *strnode,StringNode *left,StringNode *right,int bf){
  strnode->left = left;
  strnode->right = right;
  strnode->balanceFactor = bf;
}

void giveInitStrdata(void){
  nodeAndy.str = "Andy";
  nodeThengChun.str = "ThengChun";
  nodeRex.str = "Rex";
  nodeJstan.str = "Jstan";
  nodeAlexander.str = "Alexander";
}
